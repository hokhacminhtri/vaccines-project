    ...
    <>
      ...
      <Container sx={{paddingBottom:5}}>
        <div class="row div-breckum">
          <div class="col-xs-12">
            <span typeof="v:Breadcrumb"><a href="/" rel="v:url" property="v:title">TRANG CHỦ</a> » <span class="breadcrumb_last">Tiêm Chủng Cho Người Lớn</span></span>
          </div>
        </div>
        <h3 class="content-title">
			    <span class="text-blue">TIÊM CHỦNG CHO NGƯỜI LỚN</span>
		    </h3>
        <p>
        Theo thống kê của Tổ chức Y tế Thế giới WHO, mỗi năm có đến 600.000 người lớn tử vong vì những căn bệnh truyền nhiễm nguy hiểm có thể phòng ngừa bằng vắc xin. Trong khi đó,
        người lớn lại là nhóm có tỷ lệ tiêm chủng thấp vì chưa quan tâm hoặc thiếu thông tin về việc tiêm chủng vắc xin cho người lớn. Điều này không chỉ ảnh hưởng đến sức khoẻ của
        chính họ và đặc biệt là nguy cơ lây lan bệnh dịch sang cho trẻ em. Người lớn hãy chủ động tiêm phòng để bản thân phòng tránh các căn bệnh nguy hiểm, đồng thời bảo vệ sức khỏe
