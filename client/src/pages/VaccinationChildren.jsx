      ...
      <div className="row div-breckum">
        <div className="col-xs-12">
          <span typeof="v:Breadcrumb">
            ...
            » <span className="breadcrumb_last">Tiêm Chủng Cho Trẻ Em</span>
          </span>
        </div>
      </div>
      <h3 className="content-title">
        <span className="text-blue">Tiêm Chủng Cho Trẻ Em</span>
      </h3>
      <p>
        Từ khi có vắc xin, Việt Nam đã bảo vệ hơn 1.6 triệu trẻ em khỏi gần 30
        bệnh lý truyền nhiễm có thể gây tử vong; thanh toán thủy đậu từ năm
        1979; thanh toán bại liệt từ năm 2000; thanh toán uốn ván sơ sinh từ năm
        2005; tiết kiệm hàng ngàn tỷ đồng mỗi năm cho các chi phí chăm sóc y tế…
        Chúng ta hoàn toàn có thể làm giảm tỷ lệ mắc bệnh, giảm biến chứng, giảm
        tử vong ở trẻ em dưới 5 tuổi do một số bệnh truyền nhiễm nguy hiểm gây
        ra nhờ chủng ngừa. Hãy chủ động tiêm vắc xin để con yêu lớn lên an toàn
        và khỏe mạnh!
      </p>
